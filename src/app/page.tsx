...
export default function Home() {
  ...
  return (
    <div className="z-10 flex flex-col items-center justify-center min-h-screen text-white bg-black">
      ...
      <div className="flex flex-col items-center justify-center gap-8 -mt-40 md:flex-row md:gap-16">
        ...
        {/* ✅ 데스크탑 전용 – 기존 방식 유지 */}
        <div className="flex-row items-center justify-center hidden gap-20 md:flex">
      ...
      <div className="w-full px-4 py-16 mt-32 text-white bg-black">
      ...
      <div className="relative w-full text-white bg-black">
        ...
        <div className="relative hidden md:block">
          ...
          <div className="ml-[200px] border-[#66E274] rounded-tl-3xl rounded-bl-3xl border border-t border-b border-l pb-12 pl-24 pt-12 pr-12 backdrop-blur-sm">
            ...
            {/* 버튼 */}
            {/* <div className="absolute flex gap-4 right-72 top-30">
              <button
