...
// 슬라이드 데이터는 하나만 있으므로 map을 사용하지 않고 직접 렌더링합니다.
const slideData = {
  id: 1,
          ...
          <SwiperSlide className="relative w-full">
            ...
            <div className="absolute inset-0 w-full h-full">
              <img
                ...
                className="object-cover w-full h-full" // contain -> cover로 변경하여 꽉 채움
              />
            ...
            <div className="relative z-10 flex items-center justify-center w-full h-full min-h-[651px]">
              ...
              <div className="relative p-12 text-center text-white">
                ...
                <div className="flex flex-col items-center">
                  <h1 className="text-[39px] font-semibold">BIOADDLAB CONTENT</h1>
      ...
      <div className="block md:hidden w-full h-[600px]">
        ...
        >
          <SwiperSlide className="relative w-full h-full">
            ...
            <div className="absolute inset-0 w-full h-full">
              <img
                src="/images/main1-m.png" // 모바일용 이미지 경로
                alt="Slide 1"
