...
const ContentColumn: React.FC<ContentColumnProps> = ({ imageSrc, imageAlt, mainFeature, subFeatures,title }) => {
  return (
    <div className="w-[1150px] flex-shrink-0 p-4 pt-14 pl-32">
      <h3 className='text-[#7d7d7d] text-left text-[32px] font-geist font-extrabold relative h-[27px] mb-14'>{title}</h3>
...
const MobileFeatures = () => {
  ...
  return (
    <div className='w-full min-h-[850px] flex items-center justify-center md:hidden flex-col gap-8 py-8 bg-white'>
      <h2 className='flex flex-col items-center justify-center font-extrabold text-black text-[22px] mb-0 mt-4'>
        <span>헬스케어</span>
        <span>SMART BOARD SYSTEM</span>
      </h2>
