          ...
          <SwiperSlide className="relative w-full h-full">
            ...
            <div className="relative z-10 flex items-center justify-center w-full h-full">
              <div className="relative p-12 text-center text-white">
                ...
                <h2 className="flex flex-col items-center font-geist">
                  <span className="text-[39px] font-semibold">BIOADDLAB SMART BOARD</span>
            ...
            <div className="relative z-10 flex items-center justify-center w-full h-full">
              <div className="relative p-12 text-center text-white">
                ...
                <h2 className="flex flex-col items-center leading-none font-geist">
                  <span className="text-[25px] font-light font-geist">BIOADDLAB</span>
                  <span className="text-[25px] font-light font-geist">SMART BOARD</span>
                  <span className="mt-8 text-[36px] font-['Noto_Sans'] font-extrabold bg-gradient-to-r from-[#6AE266] to-[#0090EF] bg-clip-text text-transparent">TECHNOLOGY</span>
                </h2>
              </div>
            </div>
          </SwiperSlide>
