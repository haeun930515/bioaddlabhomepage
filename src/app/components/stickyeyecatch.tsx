...
const FirstSectionUI: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-full">
      ...
      `}</style>
      <h2 style={{ position: 'absolute', left: '15%', top: '142px', color: '#ffffff', fontSize: '2.25rem', lineHeight: '139%', fontFamily: "'Suit-Bold', sans-serif", fontWeight: 'bold' }}>
                            ...
                            <div key={index} className="w-[897px] h-[430px] flex-shrink-0 relative">
                                ...
                                >
                                    <div className="flex flex-col justify-center h-full text-white">
                                        <h3 className="text-3xl font-extrabold leading-tight text-left font-suit">
                                ...
                                <h3 className="absolute top-0 w-full text-3xl font-bold text-left text-white">
                                    {data.title}
                                </h3>
                            </div>
                        ))}
